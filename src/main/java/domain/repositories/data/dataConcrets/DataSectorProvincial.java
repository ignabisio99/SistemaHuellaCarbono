...
public class DataSectorProvincial {
    private static List<EntidadPersistente> sectoresProvinciales = new ArrayList<>();

    public static List<EntidadPersistente> getList() {
        //Aca van los datos en concreto (guardarlos en la lista)

        return sectoresProvinciales;
    }

    public static void addAll(List<EntidadPersistente> listClass) {
        sectoresProvinciales.addAll(listClass);
    }
}
