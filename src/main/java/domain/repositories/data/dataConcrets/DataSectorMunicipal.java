...
public class DataSectorMunicipal {
    private static List<EntidadPersistente> sectoresMunicipales = new ArrayList<>();

    public static List<EntidadPersistente> getList() {
        //Aca van los datos en concreto (guardarlos en la lista)

        return sectoresMunicipales;
    }

    public static void addAll(List<EntidadPersistente> listClass) {
        sectoresMunicipales.addAll(listClass);
    }
}
